...
if __name__ == "__main__":
    ...
    chk("/api/research/needs", key="needs")
    chk("/api/research/log", key="searches")
    ...
    chk("/api/rules/learned", key="rules")
    chk("/api/rules/all", key="rules")
    chk("/api/sources/reliability", key="sources")
    chk("/api/sentiment/current", key="index")
    chk("/api/sentiment/history", key="history")
    chk("/api/memory", key="memories")
    chk("/api/goals/current", key="goals")
    ...
    chk("/api/actions/execution-log", key="executions")
