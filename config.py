...
# Delivery channels
# Slack: set SLACK_WEBHOOK_URL to an incoming webhook URL from api.slack.com/apps
SLACK_WEBHOOK_URL = _clean_env("SLACK_WEBHOOK_URL")
# Email: set ALERT_EMAIL_FROM, ALERT_EMAIL_TO, ALERT_EMAIL_PASS, ALERT_SMTP_HOST, ALERT_SMTP_PORT
ALERT_EMAIL_FROM = _clean_env("ALERT_EMAIL_FROM")
ALERT_EMAIL_TO = _clean_env("ALERT_EMAIL_TO")
